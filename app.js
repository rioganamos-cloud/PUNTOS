...
// Niveles por puntos (últimos 30 días)
function categoriaPorPuntos(p) {
...
// Trae movimientos de los últimos 30 días y suma puntos
...
async function verPuntos() {
  ...
  try {
    ...
    const cat = categoriaPorPuntos(total);
